 ...
 * Displays key metrics and navigation to admin management sections
 */
export default function AdminDashboardScreen({ navigation }) {
  ...
  const loadDashboard = async () => {
    try {
      ...
      console.error("Failed to load dashboard:", e.message);
    }
  };
  ...
  return (
    <Screen>
      ...
      <SecondaryButton 
        ...
        onPress={() => navigation.navigate("AdminLendingRequests")} 
        style={{ marginTop: spacing.sm }} 
      />
      <SecondaryButton 
